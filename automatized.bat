...
start /min cmd /k "cd C:\Users\CybeRooT\Desktop\Sonatel Academy\transfert\transfert-frontEnd && tsc --watch"
start /min "" cmd /k "cd C:\Users\CybeRooT\Desktop\Sonatel Academy\transfert\transfert-backend && php artisan serve"
start /min "" cmd /k "cd C:\Users\CybeRooT\Desktop\Sonatel Academy\transfert\transfert-frontEnd && npx lite-server"
start /min "" cmd /k "cd C:\Users\CybeRooT\Desktop\Sonatel Academy\transfert\transfert-frontEnd && code . && exit"
